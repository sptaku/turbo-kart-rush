...
//   ヘアピン×2・直角×2・ジャンプ必須×2・分岐×3＋動くサッカーボール＋こぼれ罠。
...
// 分岐×3: BR1=右直線の内側レーン / BR2=左直線の内側レーン / BR3=ヘアピン1を突っ切る近道
const T11_BRANCHES = [
  [[146, 108], [134, 86], [144, 64]],
  [[20, 88], [34, 106], [30, 130]],
  [[111, 52], [103, 50], [95, 52]],
];
...
const TRACKS = [
...

  {
    ...
    items: itemRow(T11, [6, 16, 24], [-0.8, 0, 0.8]),
    boosts: pick(T11, [9, 22]),
    hazards: pick(T11, [12, 19]),                // こぼれ罠(ヘアピン出口)
